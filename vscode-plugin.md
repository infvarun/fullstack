# VSCode setup for convenient coding
...
If you want your editor to work and look exactly the same way as mine does, you can copy these settings to your own settings file. Just go to settings in VSCode, and on the right side, you can paste this code.
